...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".button {\r\n  color: #61677c;\r\n  font-weight: bold;\r\n  box-shadow: -5px -5px 20px #fff, 5px 5px 20px #babecc;\r\n  transition: all 0.2s ease-in-out;\r\n  cursor: pointer;\r\n  font-weight: 600;\r\n}\r\n", "",{"version":3,"sources":["webpack://./src/App.css"],"names":[],"mappings":"AAAA;EACE,cAAc;EACd,iBAAiB;EACjB,qDAAqD;EACrD,gCAAgC;EAChC,eAAe;EACf,gBAAgB;AAClB","sourcesContent":[".button {\r\n  color: #61677c;\r\n  font-weight: bold;\r\n  box-shadow: -5px -5px 20px #fff, 5px 5px 20px #babecc;\r\n  transition: all 0.2s ease-in-out;\r\n  cursor: pointer;\r\n  font-weight: 600;\r\n}\r\n"],"sourceRoot":""}]);
// Exports
...
function App_App(){(0,react.useEffect)(function(){var a1=document.getElementsByClassName('dynamic');Array.prototype.map.call(a1,function(fatherItem){var a2=fatherItem.getElementsByClassName('label label-id');var a3=Array.prototype.map.call(a2,function(el){return el.innerText;});var bugAry=noRepeat(a3);var dynamicDate=fatherItem.getElementsByClassName('dynamic-date');var timeline=fatherItem.getElementsByClassName('timeline');var oldButton=document.createElement('div');var Button=bugAry.length===0?/*#__PURE__*/(0,jsx_runtime.jsx)("button",{style:{textAlign:'center',marginTop:5},children:"\u6682\u65E0bug"}):/*#__PURE__*/(0,jsx_runtime.jsxs)("button",{style:{marginTop:5,textAlign:'center'},onClick:function onClick(){return copyUrl(bugAry.join(','));},children:["\u5F53\u5929\u4FEE\u6539\u7684bug",/*#__PURE__*/(0,jsx_runtime.jsx)("br",{}),"(",bugAry.length,")"]});dynamicDate[0].style.height='94px';timeline[0].style.marginBottom='56px';react_dom.render(Button,oldButton);dynamicDate[0].appendChild(oldButton);});},[]);return/*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment,{});}/* harmony default export */ var src_App_0 = (App_App);
